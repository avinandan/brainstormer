		...
		///////////////////////////////
					...
					function prepareSlides(top,opt) {
						...
						top.find('ul:first > li').each(function(i) {
							...
							img.wrap('<div class="imgholder" style="cursor:default;position:relative"></div>');
					...
					function prepareSlidesContainer(top,opt) {
						top.find('ul:first').wrap('<div class="main-container" style="z-index:7;position:absolute;top:0px;left:0px;width:'+opt.width+'px;height:'+opt.height+'px;"><div class="slider_holder" style="position:relative;width:'+opt.width+'px;height:'+opt.height+'px;"></div></div>');
