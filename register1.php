		...
		<article class="col1">
			<div class="pad_left1 pad_bot1">
			 <h2>Register Here !!</h2>
				  ...
				  <h3><b>Member 2 Details</b></h3>
				  <form name="register1" method="post" action="reg-exec1.php">
				  
				  Your Group Name:&nbsp;&nbsp;&nbsp;
				  <? echo $_SESSION['gname'];?></br></br>
				  Name of 2nd Member: <br/> <input type="text" size="30" name="name1" onfocus="if (this.value == 'Name of 2nd member') {this.value=''}" 
				  value="<?if($_SESSION['gname']) echo $_SESSION['SESS_NAME2']; else{?>Name of 2nd member<?}?>" onblur="if (this.value=='') {hero('grp','Enter the name of 2nd member of your group')}" onclick="gone('grp')" size="30"/>
				  <div id="grp"></div></br>
				  
				  Institute Name:<br/> <input type="text" size="50" name="ins1" value="<?if($_SESSION['gname']) echo $_SESSION['SESS_INS2']; else{?>Same institute<?}?>" onfocus="if(this.value=='Same institute') {this.value=''};"
				  size="30"/><br/><br/>
				  			  
				  <h3><b>Member 3 Details</b></h3>
				  Name of 3rd Member:<br/><input type="text" name="name2" size="30" value="<?if($_SESSION['gname']) echo $_SESSION['SESS_NAME3']; else{?>Name of 3rd member<?}?>" onfocus="if (this.value == 'Name of 3rd member') {this.value=''}"/><br/><br/>
				  
				  Institute Name:<br/> <input type="text" size="50" name="ins2" value="<?if($_SESSION['gname']) echo $_SESSION['SESS_INS3']; else{?>Same institute<?}?>" onfocus="if(this.value=='Same institute.') {this.value=''};"
				  size="30"/>  <br/><br/>
				  ...
				  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				  <a href="regok.php"><img src="images/skip.png" /> </a>
				  </form>
