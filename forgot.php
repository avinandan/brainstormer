		...
		<article class="col1">
			<div class="pad_left1 pad_bot1">
			 <h2>Reset Password</h2>
                 ...
                 <form method="post" action="forgot-exec.php" name="forgot">
				  Team Name:</br>
				  <input type="text" size="30" name="gname" onfocus="if (this.value == 'Your group name') {this.value=''}" 
				  value="Your group name" onblur="if (this.value=='') {hero('grp','Enter your desired goup name')}" onclick="gone('grp')" size="30"/><br/><br/>
				  Email:<br/><input type="text" name="email" size="30" value="Your email id" onblur="emailcheck(this.value);" onfocus="if (this.value == 'Your email id') {this.value=''}" onclick="gone('email')"/>
				  </br></br>
				   New Password:<br/> <input type="password" size="30" name="passwd"  
				  ...
				  <INPUT TYPE="image" SRC="images/reset.jpg"WIDTH="67"  HEIGHT="26" BORDER="0" ALT="SUBMIT!"/>
				  </form>
