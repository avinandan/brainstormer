	...
	<section id="content">
		...
		<article class="col1">
			<div class="pad_left1 pad_bot1">
			 <h2>Login</h2>
				  <br/><br/>
				  <form method="post" action="log-exec.php" name="login">
				  <b>Team Name:</b></br>
				  <input type="text" size="30" name="gname"/><br/><br/>
				  <b>Password:</b></br>
				  <input type="password" size="30" name="passwd"/></br> 
				  </br>
				   <INPUT TYPE="image" SRC="images/login.png"WIDTH="67"  HEIGHT="26" BORDER="0" ALT="SUBMIT!"/> 
				   &nbsp  &nbsp   <!-- <a href="forgot.php">Forgot password ?</a> --> 
				   
					 </form>
					 </br>
					       Not registered your Team yet ?
						   <a href="register.php">Click here</a>    to register your team.
