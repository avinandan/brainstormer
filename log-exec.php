<?php
	...
	*/
	...
	$qry="SELECT * FROM reguser WHERE gname='$gname' AND password='$password'";
	...
	if($result) {
		if(mysql_num_rows($result) == 1) {
			...
			$_SESSION['SESS_MEMBER_ID'] = $members['id'];
			$_SESSION['SESS_GNAME'] = $members['gname'];
			$_SESSION['SESS_NAME1'] = $members['name1'];
			$_SESSION['SESS_INS1'] = $members['institue1'];
			
			$_SESSION['SESS_EMAIL'] = $members['email1'];
			$_SESSION['SESS_NAME2'] = $members['name2'];
			$_SESSION['SESS_INS2'] = $members['institue2'];
			$_SESSION['SESS_NAME3'] = $members['name3'];
			$_SESSION['SESS_INS3'] = $members['institue3'];
			$_SESSION['SESS_PH1']= $members['ph1'];
			//session_write_close();
		...
		<article class="col1">
			<div class="pad_left1 pad_bot1">
			 <h2>Team Details</h2>
				 ...
				 <? echo "Group Name :" . $_SESSION['SESS_GNAME'] . "</br>";?> 
				  
				  <h3>Member 1 Details</h3>
				  <?
				  echo "Name:" . $_SESSION['SESS_NAME1'] . "</br>";
				  echo "Institute:" . $_SESSION['SESS_INS1'] . "</br>";
				  echo "Mobile No.: " . $_SESSION['SESS_PH1'] ."</br>";
				  echo "Email-id : " . $_SESSION['SESS_EMAIL'] ."</br>";
				  ?>				  
				  <h3>Member 2 Details</h3>
				  				  <?
				  echo "Name:" . $_SESSION['SESS_NAME2'] . "</br>";
				  echo "Institute:" . $_SESSION['SESS_INS2'] . "</br>";
				  ?>				  

				  			  
				  <h3>Member 3 Details</h3>
				  				  <?
				  echo "Name:" . $_SESSION['SESS_NAME3'] . "</br>";
				  echo "Institute:" . $_SESSION['SESS_INS3'] . "</br>";
				  ?>				  

				  <a href="register1.php">Edit your team</a>
			...
			<article class="col2">
				...
				<div class="ul_works"> 
                      <Marquee direction="up" behaviour="scroll" scrollamount="3" onMouseOver="this.stop()" onMouseOut="this.start()">
                          <a href="#" align="left" color="white">registration has begun 
						  </a>
                      </Marquee> 
                    </div> 
				<h4>Sponsors</h4>
